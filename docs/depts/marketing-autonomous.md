...
Canonical brand voice, four-platform matrix, and agent guardrails: **`docs/depts/marketing.md`** (Marketing Bible).
...
- [ ] **Message house** — 3 pillars + proof points (must match **`marketing.md`** + Product reality).
